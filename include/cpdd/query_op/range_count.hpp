...
size_t ParallelKDtree<point>::range_count(
...
template<typename point>
size_t ParallelKDtree<point>::range_count_rectangle(node* T,
                                                    const box& queryBox,
                                                    const box& nodeBox,
                                                    size_t& visLeafNum,
                                                    size_t& visInterNum) {
...
template<typename point>
size_t ParallelKDtree<point>::range_count_radius(node* T, const circle& cl,
                                                 const box& nodeBox) {
