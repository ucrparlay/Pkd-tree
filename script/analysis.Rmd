...
kd_q <- read.csv("script/backup_data/my_kd_q.csv", header = TRUE)
kd_bq <- read.csv("script/backup_data/my_kd_bq.csv", header = TRUE)
kd_kq <- read.csv("script/backup_data/my_kd_kq.csv", header = TRUE)
cgal <- read.csv("script/backup_data/cgal.csv", header = TRUE)
t <- cgal %>% bind_rows(kd_q, kd_bq, kd_kq)
t
```
