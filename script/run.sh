...
INBALANCE_RATIO=30 ../build/test -p /data/zmen002/kdtree/ss_varden/1000000000_3/1.in -k 10 -t 0 -d 3 -q 32768 -i 0 -r 1 | tee "data/inba30_od_remote.log"
INBALANCE_RATIO=40 ../build/test -p /data/zmen002/kdtree/ss_varden/1000000000_3/1.in -k 10 -t 0 -d 3 -q 32768 -i 0 -r 1 | tee "data/inba40_od_remote.log"
INBALANCE_RATIO=48 ../build/test -p /data/zmen002/kdtree/ss_varden/1000000000_3/1.in -k 10 -t 0 -d 3 -q 32768 -i 0 -r 1 | tee "data/inba48_od_remote.log"
INBALANCE_RATIO=49 ../build/test -p /data/zmen002/kdtree/ss_varden/1000000000_3/1.in -k 10 -t 0 -d 3 -q 32768 -i 0 -r 1 | tee "data/inba49_od_remote.log"
